...
bar_length = (8 * 60 / bpm) * 1000

# the fade duration in milliseconds
fade_duration = 50  # 50ms, adjust as needed

# directory where you have your wav files
dir_path = '/Samples'  # replace this with your actual path
...
for filename in files:
    ...
    if filename.endswith('.wav'):
        ...
        # create a folder for the bars
        folder = os.path.join(dir_path, f"{filename_no_ext}_chop")
